...
### **G-01: 로컬라이징 전용 탭 기능 개발** 🔥 **진행 중 - 2025/06/24 11:07**
...
- [ ] 검색/필터링 기능
- [ ] 되돌리기 기능
- [ ] 유효성 검사 (중복 키 경고 및 작업 취소, 중복 텍스트 경고)
- [ ] 탭 전환 시 데이터 동기화
...
**다음 단계 계획**:
- Dialogue CSV 편집 기능 완성 (EditorStore 연동)
- 검색/필터링 기능 완성
- 되돌리기 기능 구현
- 탭 전환 시 데이터 동기화 구현

**기술적 고려사항**:
- LocalizationStore와 EditorStore 간 데이터 동기화
- CSV 데이터 구조 기반 테이블 렌더링
- 편집 상태 관리 및 변경사항 추적
- 유효성 검사 로직 구현
