...
export const DialogueSchema = z.discriminatedUnion("type", [TextDialogueSchema, ChoiceDialogueSchema, InputDialogueSchema]);
...
export const TemplateDialoguesSchema = z
  .record(
